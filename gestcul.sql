...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 04 oct. 2024 à 21:40
...
(2, 'Poivron', 3, 'legume', 'Roma'),
(3, 'Piment', 2, 'legume', 'Piment Cayenne'),
(5, 'Haricots', 4, 'legume', 'Roma'),
(6, 'Blé', 8, 'legume', 'Blé blanc d\'hiver'),
(7, 'Mil', 4, 'legume', 'Roma'),
(8, 'Maïs', 3, 'céréale', 'Maïs blanc'),
(9, 'Piment', 3, 'céréale', 'Piment Jalapeño');
...
(1, '2024-09-07', 2.00, 'Irrigations', 3, '2024-12-01', 8800.00, 0.25, 'Engrais NPK', 0.15),
